...
"left":loadingBarLeft,"bottom":loadingBarBottom});_css(".round",{"width":setRoundWidth,"height":setRoundWidth});_css(".pointer",{"width":setPointerWidth,"height":setPointerWidth,"left":rotCenter,"top":rotCenter*2});_css(".zoom",{"top":setRoundWidth+setRoundWidth/10+10,"left":(setRoundWidth-30)/2-3});if(changeAxis)_css(".zoom",{"top":25,"left":(setRoundWidth-30)/2-3});else _css(".zoom",{"top":setRoundWidth+setRoundWidth/10+10,"right":(setRoundWidth-30)/2-3});_css(".pointer_object",{"width":setPointerObjectWidth,
